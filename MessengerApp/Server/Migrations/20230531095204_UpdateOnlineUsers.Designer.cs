...
namespace MessengerApp.Server.Migrations
{
    ...
    [Migration("20230531095204_UpdateOnlineUsers")]
    partial class UpdateOnlineUsers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MessengerApp.Server.Entyties.OnlineUser", b =>
                {
                    b.Property<string>("OnlineUserId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("OnlineUserConnection")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MessengerApp.Server.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
